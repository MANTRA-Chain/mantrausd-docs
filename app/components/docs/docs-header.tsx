            ...
            <div className="flex items-center gap-1 sm:gap-2">
              {siteConfig.navbar?.links?.map((link) => (
                <a
                  ...
                  className="hidden md:inline-flex px-3 py-2 text-sm text-muted-foreground hover:text-foreground transition-colors"
                >
                  {link.label}
                </a>
              ))}
              {siteConfig.navbar?.primary && (
                <a
                  href={siteConfig.navbar.primary.href}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hidden sm:inline-flex items-center px-3 py-1.5 rounded-md bg-[var(--accent)] text-[var(--accent-foreground)] text-sm font-medium hover:opacity-90 transition-opacity"
                >
                  {siteConfig.navbar.primary.label}
                </a>
              )}
